...
<h1><u style="color: white">You Are Placing order as <%=a %></u></h1><br>
<form action="order" method="post">
<fieldset style="width: 450px">
<legend>Order Details</legend>
<table height="300px" width="440px">
<tr><td>Name</td><td><input type="text" name="name" size="40"></td></tr>
<tr><td>Address</td><td><textarea cols="30" rows="3" name="address"></textarea></td></tr>
<tr><td>State</td><td><input type="text" name="State" size="40"></td></tr>
<tr><td>Country</td><td><input type="text" name="country" size="40"></td></tr>
<tr><td>Postal Code</td><td><input type="text" name="postal" size="40"></td></tr>
<tr><td>Phone Number</td><td><input type="text" name="number" size="40"></td></tr>
<tr><td>Quantity</td><td><input type="number" name="quantity" size="40"></td></tr>
<tr><td>Landmark</td><td><input type="text" name="landmark" size="40"></td></tr>
<tr><th colspan="2"><input type="submit" value="Place order"></th></tr>
</table>
</fieldset>
</form></font></center>
</div>
