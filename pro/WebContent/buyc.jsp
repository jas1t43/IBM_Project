...
<table cellspacing="0" border=1 width="500" height="800">
			<tr><th>Model Name</th><th><%=rs.getString("PName")%></th></tr>
			<tr><th>Model ID</th><th><%=rs.getString("Model")%></th></tr>
			<tr><th>Brand</th><th><%=rs.getString("Brand")%></th></tr>
			<tr><th>Optical Zoom</th><th><%=rs.getString("optical_zoom")%></th></tr>
			<tr><th>Auto Focus</th><th><%=rs.getString("auto_focus")%></th></tr>
			<tr><th>Mega Pixels</th><th><%=rs.getString("megapixel")%></th></tr>
			<tr><th>Image Size</th><th><%=rs.getString("image_size")%></th></tr>
			<tr><th>Video Size</th><th><%=rs.getString("video_size")%></th></tr>
			<tr><th>Screen Size</th><th><%=rs.getString("screen_size")%></th></tr>
			<tr><th>Color</th><th><%=rs.getString("color")%></th></tr>
			<tr><th>Waranty</th><th><%=rs.getString("warranty")%></th></tr></table>
</font></center>
