...
jQuery.noConflict(); jQuery(document).ready(function(){
	...
	jQuery(".nivo-controlNav").css("marginLeft",-negativemargin);
           ...
           <font color="#E7F3E0">
			...
			<tr><th>Processor</th><th><%=rs.getString("processor")%></th></tr>
			<tr><th>Screen Size</th><th><%=rs.getString("Sceen")%></th></tr>
			<tr><th>System Memory</th><th><%=rs.getString("RAM")%></th></tr>
				<tr><th>Graphic Processor</th><th><%=rs.getString("GraphicP")%></th></tr>
				<tr><th>Operating System</th><th><%=rs.getString("OS")%></th></tr>
			<tr><th>HDD Capacity</th><th><%=rs.getString("HardDisk")%></th></tr>
				<tr><th>Color</th><th><%=rs.getString("Color")%></th></tr>
				<tr><th>Warranty</th><th><%=rs.getString("Warenty")%></th></tr></table></font></center>
