...
<table cellspacing="0" border=1 width="500" height="800">
			...
			<tr><th>Internal Memory</th><th><%=rs.getString("internal_memory")%></th></tr>
			<tr><th>Operating System</th><th><%=rs.getString("os")%></th></tr>
			<tr><th>Memory (RAM)</th><th><%=rs.getString("ram")%></th></tr>
			<tr><th>Rear Camera</th><th><%=rs.getString("rear_camera")%></th></tr>
			<tr><th>Front Camera</th><th><%=rs.getString("front_camera")%></th></tr>
			<tr><th>Flash</th><th><%=rs.getString("flash")%></th></tr>
			<tr><th>Color</th><th><%=rs.getString("color")%></th></tr>
			<tr><th>Features</th><th><%=rs.getString("others")%></th></tr></table></font></center>
